...
from ssd.layers.binary_layers import BinaryConv2D
from ssd.layers.binary_ops import binary_tanh as binary_tanh_op
...
def build_model(image_size,
    ...
    H = 1.
    Act = lambda n: LeakyReLU(name=n)
    Conv2D = lambda f, k, s, r, n: BinaryConv2D(filters=f,
                                                kernel_size=k,
                                                strides=s,
                                                H=1,
                                                padding='same',
    ...
    conv1 = Conv2D(32, (3, 3), (1, 1), l2_reg, 'conv1')(x1)
    # Tensorflow uses filter format [filter_height, filter_width, in_channels, out_channels], hence axis = 3
    conv1 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn1')(conv1) 
    conv1 = Act('act1')(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2), name='pool1')(conv1)

    conv2 = Conv2D(48, (3, 3), (1, 1), l2_reg, 'conv2')(pool1)
    conv2 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn2')(conv2)
    conv2 = Act('act2')(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2), name='pool2')(conv2)

    conv3 = Conv2D(64, (3, 3), (1, 1), l2_reg, 'conv3')(pool2)
    conv3 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn3')(conv3)
    conv3 = Act('act3')(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2), name='pool3')(conv3)

    conv4 = Conv2D(64, (3, 3), (1, 1), l2_reg, 'conv4')(pool3)
    conv4 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn4')(conv4)
    conv4 = Act('act4')(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2), name='pool4')(conv4)

    conv5 = Conv2D(48, (3, 3), (1, 1), l2_reg, 'conv5')(pool4)
    conv5 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn5')(conv5)
    conv5 = Act('act5')(conv5)
    pool5 = MaxPooling2D(pool_size=(2, 2), name='pool5')(conv5)

    conv6 = Conv2D(48, (3, 3), (1, 1), l2_reg, 'conv6')(pool5)
    conv6 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn6')(conv6)
    conv6 = Act('act6')(conv6)
    pool6 = MaxPooling2D(pool_size=(2, 2), name='pool6')(conv6)

    conv7 = Conv2D(32, (3, 3), (1, 1), l2_reg, 'conv7')(pool6)
    conv7 = BatchNormalization(axis=3, momentum=0.01, epsilon=0.0001, name='bn7')(conv7)
    conv7 = Act('act7')(conv7)

    # Output shape of `classes`: `(batch, height, width, n_boxes * n_classes)`
    classes4 = Conv2D(n_boxes[0] * n_classes, (3, 3), (1, 1), l2_reg, 'classes4')(conv4)
    classes5 = Conv2D(n_boxes[1] * n_classes, (3, 3), (1, 1), l2_reg, 'classes5')(conv5)
    classes6 = Conv2D(n_boxes[2] * n_classes, (3, 3), (1, 1), l2_reg, 'classes6')(conv6)
    classes7 = Conv2D(n_boxes[3] * n_classes, (3, 3), (1, 1), l2_reg, 'classes7')(conv7)
    
    # Output shape of `boxes`: `(batch, height, width, n_boxes * 4)`
    boxes4 = Conv2D(n_boxes[0] * 4, (3, 3), (1, 1), l2_reg, 'boxes4')(conv4)
    boxes5 = Conv2D(n_boxes[1] * 4, (3, 3), (1, 1), l2_reg, 'boxes5')(conv5)
    boxes6 = Conv2D(n_boxes[2] * 4, (3, 3), (1, 1), l2_reg, 'boxes6')(conv6)
    boxes7 = Conv2D(n_boxes[3] * 4, (3, 3), (1, 1), l2_reg, 'boxes7')(conv7)

...
#         self.alpha = tf.constant(self.alpha)
        ...
        self.neg_pos_ratio = tf.Variable(self.neg_pos_ratio)
        ...
        def f2():
            ...
            values, indices = tf.nn.top_k(neg_class_loss_all_1D,
                                          k=n_negative_keep,
                                          sorted=False) # We don't need them sorted.The name tf.reset_default_graph is deprecated. Please use tf.compat.v1.reset_default_graph instead.
